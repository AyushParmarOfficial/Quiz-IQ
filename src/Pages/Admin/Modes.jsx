...
export default function Modes() {
    ...
    const editMode = async (e) => {
        e.preventDefault();
        const url2 = `admin/modes/${id}`;
        await postApi(edit, setEdit, url2,setError, setSuccess);
        closeModal();
        handleData();
    }
    ...
    return (
        <>
            ...
            <div className="flex items-center justify-between">
                <h1 className="text-6xl">Modes</h1>
                <button onClick={openAddModal} className={`${themeMode === 'dark' ? "text-black font-medium bg-gray-200 " : " text-white bg-gray-700"} p-2 rounded-[5px]`}>Add Mode</button>
            </div>
            ...
            {addShow && (
                <div className="fixed inset-0 backdrop-blur-xs bg-opacity-50 flex justify-center items-center z-50">
                    <div className={`${themeMode === 'dark' ? "bg-black" : "bg-white"}  p-6 rounded-lg shadow-lg w-96`}>
                        <h2 className="text-xl font-bold mb-4">Add Mode </h2>
